            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  AppTextField(
                    validator: Validator.checkMainScheduleName,
                  ...
                  AppTextField(
                    validator: Validator.checkMainScheduleRemarks,
                    title: AppStrings.mainScheduleRemarks,
                    viewBorder: false,
                    hintText: AppStrings.enterMainScheduleRemarks,
                    shadowColor: ColorManager.lightGrey,
                    elevation: 10,
                    controller: controller.mainScheduleRemarkController,
                  ),

...
class LedgerGroupList extends GetView<LedgerGroupListController> {
  const LedgerGroupList({super.key});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ValueListenableBuilder<Box<LedgerGroup>>(
              valueListenable: HiveBox.ledgerGroupBox().listenable(),
              builder: (BuildContext context, box, Widget? child) {
                var data = box.values.toList().cast<LedgerGroup>();

...
class DivisionList extends GetView<DivisionListController> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ValueListenableBuilder<Box<Division>>(
              valueListenable: HiveBox.divisionBox().listenable(),
              builder: (BuildContext context, box, Widget? child) {
                var data = box.values.toList().cast<Division>();
